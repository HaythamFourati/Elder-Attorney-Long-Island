<?php
/**
 * Template Name: Probate
 * Service Page - Probate & Administration
 */
      ...
      <div class="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        <div class="service-hero-content">
          ...
          <p class="text-lg text-muted-foreground mb-8 leading-relaxed max-w-lg">
            Guiding families through the estate settlement process with compassion, expertise, and attention to detail during difficult times.
          </p>
        ...
        <div class="relative mt-8 lg:mt-0">
          <div class="service-hero-image relative rounded-2xl lg:rounded-3xl overflow-hidden aspect-[4/3]">
            ...
            <img 
              ...
              alt="Probate and estate administration legal services" 
      ...
      <div class="grid lg:grid-cols-3 gap-8 lg:gap-12">
        ...
        <div class="lg:col-span-2 service-content">
          ...
          <p class="text-muted-foreground text-[15px] leading-relaxed mb-6">
            Probate is the legal process of administering a deceased person's estate. This includes validating the will (if one exists), identifying and inventorying assets, paying debts and taxes, and distributing the remaining assets to beneficiaries. In New York, the probate process is handled by the Surrogate's Court.
          </p>
          <p class="text-muted-foreground text-[15px] leading-relaxed mb-8">
            At Elder Attorney Long Island, we guide executors and administrators through every step of the probate process, ensuring compliance with legal requirements while minimizing stress during an already difficult time.
          </p>

          <h3 class="text-xl font-semibold text-foreground mb-4">Our Probate Services Include:</h3>
          <ul class="space-y-4 mb-8">
            <li class="flex items-start gap-3">
              ...
              <div>
                <p class="font-medium text-foreground">Will Probate</p>
                <p class="text-[14px] text-muted-foreground">Filing the will with Surrogate's Court and obtaining Letters Testamentary for the executor.</p>
              </div>
            </li>
            <li class="flex items-start gap-3">
              <div class="w-6 h-6 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <div>
                <p class="font-medium text-foreground">Estate Administration</p>
                <p class="text-[14px] text-muted-foreground">Managing the estate when there is no will (intestate), including obtaining Letters of Administration.</p>
              </div>
            </li>
            <li class="flex items-start gap-3">
              <div class="w-6 h-6 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <div>
                <p class="font-medium text-foreground">Asset Identification & Valuation</p>
                <p class="text-[14px] text-muted-foreground">Locating, inventorying, and appraising all estate assets.</p>
              </div>
            </li>
            <li class="flex items-start gap-3">
              <div class="w-6 h-6 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <div>
                <p class="font-medium text-foreground">Creditor Claims</p>
                <p class="text-[14px] text-muted-foreground">Notifying creditors and handling legitimate claims against the estate.</p>
              </div>
            </li>
            <li class="flex items-start gap-3">
              <div class="w-6 h-6 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <div>
                <p class="font-medium text-foreground">Tax Filings</p>
                <p class="text-[14px] text-muted-foreground">Preparing and filing estate tax returns and final income tax returns.</p>
              </div>
            </li>
            <li class="flex items-start gap-3">
              <div class="w-6 h-6 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0 mt-0.5">
              ...
              <div>
                <p class="font-medium text-foreground">Asset Distribution</p>
                <p class="text-[14px] text-muted-foreground">Distributing assets to beneficiaries according to the will or state law.</p>
              </div>
            </li>
          </ul>

          <h3 class="text-xl font-semibold text-foreground mb-4">The Probate Process in New York</h3>
          <p class="text-muted-foreground text-[15px] leading-relaxed mb-6">
            The New York probate process can be complex and time-consuming. Understanding what to expect can help ease the burden:
          </p>
          <div class="grid sm:grid-cols-2 gap-4 mb-8">
            <div class="p-4 rounded-xl bg-primary/5 border border-primary/10">
              <p class="font-medium text-foreground text-[15px]">Filing the Petition</p>
              <p class="text-[13px] text-muted-foreground mt-1">Submit the will and petition to Surrogate's Court to begin the process.</p>
            </div>
            <div class="p-4 rounded-xl bg-primary/5 border border-primary/10">
              <p class="font-medium text-foreground text-[15px]">Notice to Heirs</p>
              <p class="text-[13px] text-muted-foreground mt-1">All interested parties must be notified and given opportunity to object.</p>
            </div>
            <div class="p-4 rounded-xl bg-primary/5 border border-primary/10">
              <p class="font-medium text-foreground text-[15px]">Letters Issued</p>
              <p class="text-[13px] text-muted-foreground mt-1">Court issues Letters Testamentary or Administration to the fiduciary.</p>
            </div>
            <div class="p-4 rounded-xl bg-primary/5 border border-primary/10">
              <p class="font-medium text-foreground text-[15px]">Estate Settlement</p>
              <p class="text-[13px] text-muted-foreground mt-1">Pay debts, file taxes, and distribute assets to close the estate.</p>
            </div>
          </div>
        </div>
          ...
          <div class="sticky top-8 space-y-6">
            ...
            <div class="bg-primary rounded-2xl p-6 text-white">
              ...
              <p class="text-white/80 text-[14px] mb-5">
                Get personalized guidance on probate and estate administration. We're here to help during this difficult time.
              </p>
