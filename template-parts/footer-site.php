    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
      ...
      <div class="lg:col-span-4">
        ...
        <div class="flex items-center gap-3">
          <a href="#" class="w-9 h-9 rounded-lg bg-white/10 hover:bg-primary flex items-center justify-center transition-colors" aria-label="Facebook">
          ...
          <a href="#" class="w-9 h-9 rounded-lg bg-white/10 hover:bg-primary flex items-center justify-center transition-colors" aria-label="LinkedIn">
          ...
          <a href="https://share.google/VxXBn1SQ9iiWE1Jtx" target="_blank" rel="noopener noreferrer" class="w-9 h-9 rounded-lg bg-white/10 hover:bg-primary flex items-center justify-center transition-colors" aria-label="Google Reviews">
      ...
      <nav aria-label="Practice Areas" class="lg:col-span-2">
        ...
        <ul class="space-y-3">
          <li><a href="#practice-areas" class="text-[13px] text-white/60 hover:text-white transition-colors">Long-Term Care</a></li>
          <li><a href="#practice-areas" class="text-[13px] text-white/60 hover:text-white transition-colors">Elder Law</a></li>
          <li><a href="#practice-areas" class="text-[13px] text-white/60 hover:text-white transition-colors">Estate Planning</a></li>
          <li><a href="#practice-areas" class="text-[13px] text-white/60 hover:text-white transition-colors">Medicaid Planning</a></li>
          <li><a href="#practice-areas" class="text-[13px] text-white/60 hover:text-white transition-colors">Asset Protection</a></li>
          <li><a href="#practice-areas" class="text-[13px] text-white/60 hover:text-white transition-colors">Probate</a></li>
        </ul>
      </nav>
      ...
      <nav aria-label="Quick Links" class="lg:col-span-2">
        ...
        <ul class="space-y-3">
          <li><a href="#about" class="text-[13px] text-white/60 hover:text-white transition-colors">About Us</a></li>
          <li><a href="#testimonials" class="text-[13px] text-white/60 hover:text-white transition-colors">Testimonials</a></li>
          <li><a href="#contact" class="text-[13px] text-white/60 hover:text-white transition-colors">Contact</a></li>
          <li><a href="#" class="text-[13px] text-white/60 hover:text-white transition-colors">Blog</a></li>
      ...
      <div class="lg:col-span-4">
        ...
        <address class="space-y-4 not-italic">
          <a href="tel:888-851-2272" class="flex items-center gap-3 text-[13px] text-white/60 hover:text-white transition-colors">
            <div class="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center flex-shrink-0">
              <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
            </div>
            888-851-2272
          </a>
          <a href="mailto:info@elderattorneylongisland.com" class="flex items-center gap-3 text-[13px] text-white/60 hover:text-white transition-colors">
            <div class="w-8 h-8 rounded-lg bg-white/10 flex items-center justify-center flex-shrink-0">
          ...
          <div class="flex items-start gap-3 text-[13px] text-white/60">
            ...
            <div class="space-y-1">
              <p>445 Broadhollow Rd, Suite C1 18, Melville, NY</p>
              <p>247-67 Jericho Tpke, Bellerose, NY</p>
            </div>
          </div>
        </address>
      </div>
